 ...
 * };
 */
export declare const SourceContext: import("react").Context<SourceContextValue>;
export declare const SourceContextProvider: import("react").Provider<SourceContextValue>;
export declare const useSourceContext: () => SourceContextValue;
export declare const useOptionalSourceContext: () => SourceContextValue;
